...
b_hardhit = find_col(batters, ["hard_hit", "hardhit"])
...
p_hardhit = find_col(pitchers, ["hard_hit", "hardhit"])
...
def cell_class_grade(g):
    return {"A+": "#166534", "A": "#15803d", "A-": "#16a34a", "B+": "#2563eb", "B": "#4f46e5", "C": "#6d28d9"}.get(g, "#6d28d9")

def html_table(df):
    cols = ["Batter", "Batter Team", "Grade", "HR Probability", "Recent Form", "Pitcher", "Pitcher Team", "Batter Power", "Pitcher Vulnerability", "Context Score", "Power Match", "Game Status", "Lineup", "Order", "EV", "HR Odds"]
    h = '<div style="overflow-x:auto;border:1px solid #1f2937;border-radius:18px"><table style="width:100%;border-collapse:collapse;background:#0b1220;color:white;font-size:14px">'
